...
```{r logistic_Lsize-distance_nurs}
for (sp in my_nur_species){
  print(sp)
...
for (sp in glm_nur_species){
  print(sp)
  res <- glm(df.sample_data[,c(sp)] ~ df.sample_data$distance_seagrass * df.sample_data$size_seagrass * df.sample_data$mpa * df.sample_data$depth, family="poisson")
  print(summary(res))
  par(mfrow=c(1,2)) 
  plot(fitted(res),residuals(res),xlab="Fitted values", ylab="Residuals", abline(h=0, lty=2))
  tryCatch( 
...
for (sp in glm_nur_species){
  print(sp)
  res <- glm(df.sample_data[,c(sp)] ~ df.sample_data$distance_seagrass * (log(df.sample_data$size_seagrass)) * df.sample_data$mpa * df.sample_data$depth, family="poisson")
  print(summary(res))
  par(mfrow=c(1,2)) 
  plot(fitted(res),residuals(res),xlab="Fitted values", ylab="Residuals", abline(h=0, lty=2))
  tryCatch( 
...
for (sp in glm_nur_species){
  print(sp)
  res <- glm(df.sample_data[,c(sp)] ~ (log(df.sample_data$distance_seagrass)) * df.sample_data$size_seagrass * df.sample_data$mpa * df.sample_data$depth, family="poisson")
  print(summary(res))
  par(mfrow=c(1,2)) 
  plot(fitted(res),residuals(res),xlab="Fitted values", ylab="Residuals", abline(h=0, lty=2))
  tryCatch( 
...
for (sp in glm_nur_species){
  print(sp)
  res <- glm(df.sample_data[,c(sp)] ~ (log(df.sample_data$distance_seagrass)) * (log(df.sample_data$size_seagrass)) * df.sample_data$mpa * df.sample_data$depth, family="poisson")
  print(summary(res))
  par(mfrow=c(1,2)) 
  plot(fitted(res),residuals(res),xlab="Fitted values", ylab="Residuals", abline(h=0, lty=2))
  tryCatch( 
...
for (sp in glm_nur_species){
  print(sp)
  res <- glm(df.sample_data[,c(sp)] ~ df.sample_data$distance_seagrass * (log10(df.sample_data$size_seagrass)) * df.sample_data$mpa * df.sample_data$depth, family="poisson")
  print(summary(res))
  par(mfrow=c(1,2)) 
  plot(fitted(res),residuals(res),xlab="Fitted values", ylab="Residuals", abline(h=0, lty=2))
  tryCatch( 
...
for (sp in glm_nur_species){
  print(sp)
  res <- glm(df.sample_data[,c(sp)] ~ (log10(df.sample_data$distance_seagrass)) * df.sample_data$size_seagrass * df.sample_data$mpa * df.sample_data$depth, family="poisson")
  print(summary(res))
  par(mfrow=c(1,2)) 
  plot(fitted(res),residuals(res),xlab="Fitted values", ylab="Residuals", abline(h=0, lty=2))
  tryCatch( 
...
for (sp in glm_nur_species){
  print(sp)
  res <- glm(df.sample_data[,c(sp)] ~ (log10(df.sample_data$distance_seagrass)) * (log10(df.sample_data$size_seagrass)) * df.sample_data$mpa * df.sample_data$depth, family="poisson")
  print(summary(res))
  par(mfrow=c(1,2)) 
  plot(fitted(res),residuals(res),xlab="Fitted values", ylab="Residuals", abline(h=0, lty=2))
  tryCatch( 
...
```{r glm_Pois_nur_Labundance_loop}
for (sp in glm_nur_species){
  print(sp)
  res <- glm((log(df.sample_data[,c(sp)])) ~ df.sample_data$distance_seagrass * df.sample_data$size_seagrass * df.sample_data$mpa * df.sample_data$depth, family="poisson")
  print(summary(res))
  par(mfrow=c(1,2)) 
  plot(fitted(res),residuals(res),xlab="Fitted values", ylab="Residuals", abline(h=0, lty=2))
  tryCatch( 
...
```{r glm_Pois_Lab-size_nur_loop}
for (sp in glm_nur_species){
  print(sp)
  res <- glm((log(df.sample_data[,c(sp)])) ~ df.sample_data$distance_seagrass * (log(df.sample_data$size_seagrass)) * df.sample_data$mpa * df.sample_data$depth, family="poisson")
  print(summary(res))
  par(mfrow=c(1,2)) 
  plot(fitted(res),residuals(res),xlab="Fitted values", ylab="Residuals", abline(h=0, lty=2))
  tryCatch( 
...
```{r glm_Pois_Lab-distance_nur_loop}
for (sp in glm_nur_species){
  print(sp)
  res <- glm((log(df.sample_data[,c(sp)])) ~ (log(df.sample_data$distance_seagrass)) * df.sample_data$size_seagrass * df.sample_data$mpa * df.sample_data$depth, family="poisson")
  print(summary(res))
  par(mfrow=c(1,2)) 
  plot(fitted(res),residuals(res),xlab="Fitted values", ylab="Residuals", abline(h=0, lty=2))
  tryCatch( 
...
```{r glm_Pois_Lab-size-distance_nur_loop}
for (sp in glm_nur_species){
  print(sp)
  res <- glm((log(df.sample_data[,c(sp)])) ~ (log(df.sample_data$distance_seagrass)) * (log(df.sample_data$size_seagrass)) * df.sample_data$mpa * df.sample_data$depth, family="poisson")
  print(summary(res))
  par(mfrow=c(1,2)) 
  plot(fitted(res),residuals(res),xlab="Fitted values", ylab="Residuals", abline(h=0, lty=2))
  tryCatch( 
...
for (sp in glm_nur_species){
  print(sp)
  res <- glm((log10(df.sample_data[,c(sp)])) ~ df.sample_data$distance_seagrass * df.sample_data$size_seagrass * df.sample_data$mpa * df.sample_data$depth, family="poisson")
  print(summary(res))
  par(mfrow=c(1,2)) 
  plot(fitted(res),residuals(res),xlab="Fitted values", ylab="Residuals", abline(h=0, lty=2))
  tryCatch( 
...
```{r glm_Pois_L10ab-size_nur_loop}
for (sp in glm_nur_species){
  print(sp)
  res <- glm((log10(df.sample_data[,c(sp)])) ~ df.sample_data$distance_seagrass * (log10(df.sample_data$size_seagrass)) * df.sample_data$mpa * df.sample_data$depth, family="poisson")
  print(summary(res))
  par(mfrow=c(1,2)) 
  plot(fitted(res),residuals(res),xlab="Fitted values", ylab="Residuals", abline(h=0, lty=2))
  tryCatch( 
...
```{r glm_Pois_L10ab-distance_nur_loop}
for (sp in glm_nur_species){
  print(sp)
  res <- glm((log10(df.sample_data[,c(sp)])) ~ (log10(df.sample_data$distance_seagrass)) * df.sample_data$size_seagrass * df.sample_data$mpa * df.sample_data$depth, family="poisson")
  print(summary(res))
  par(mfrow=c(1,2)) 
  plot(fitted(res),residuals(res),xlab="Fitted values", ylab="Residuals", abline(h=0, lty=2))
  tryCatch( 
...
```{r glm_Pois_L10ab-size-distance_nur_loop}
for (sp in glm_nur_species){
  print(sp)
  res <- glm((log10(df.sample_data[,c(sp)])) ~ (log10(df.sample_data$distance_seagrass)) * (log10(df.sample_data$size_seagrass)) * df.sample_data$mpa * df.sample_data$depth, family="poisson")
  print(summary(res))
  par(mfrow=c(1,2)) 
  plot(fitted(res),residuals(res),xlab="Fitted values", ylab="Residuals", abline(h=0, lty=2))
  tryCatch( 
...
for (spnum in speciesrows){
  ...
  res <- glm(n[,c(sp$colname)] ~ n$distance_seagrass * n$size_seagrass * n$distance_mangroves * n$size_mangroves, family="poisson")
  print(summary(res))
  par(mfrow=c(1,2)) 
  plot(fitted(res),residuals(res),xlab="Fitted values", ylab="Residuals", abline(h=0, lty=2))
  tryCatch( 
